...
vertex(200,200)
vertex(100,200)
endShape(CLOSE)   # stops recording
...
# half heart
beginShape()
vertex(600,400) # starting (upper) vertex
bezierVertex(
  420,300, # control point for the starting vertex
  550,150, # control point for the second (lower) vertex
  600,250  # second (lower) vertex coordinates
)
endShape()
...
bezierVertex(650,150, 780,300, 600,400) # this Bezier starts from last Besier's end point 600,250
endShape()
